    ...
    <div class="row">
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <?php foreach ($subFactors as $key => $value) { ?>
                ...
                <table class="table table-bordered">
                    <tr>
                        <td class="blank"></td>
                        @foreach($subFactor['normalWeight'] as $rankKey=>$rankValue)
                        <td>{{ str_replace('normalWeight_', ' Sub Factor ',$rankKey) }}</td>
                        @endforeach
                    </tr>                
                    <tr>
                        <td>Bobot</td>
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td>{{ str_replace('normalWeight_', ' Sub Factor ',$keys) }}</td>
                    <td>{{ str_replace('normalWeight_', ' Sub Factor ',$value) }}</td>                
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            $data = [];
            foreach ($globalRank as $keys => $value) {
                $currLabel = str_replace("normalWeight_", "Sub Factor ", $keys);
