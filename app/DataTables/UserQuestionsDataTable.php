    ...
    public function ajax()
    {
        return $this->datatables
            ...
            ->addColumn('actions', function ($data) {
                            return '
                            ' . Form::open(['route' => ['userQuestions.destroy', $data->id], 'method' => 'delete']) . '
                            <div class=\'btn-group\'>
                                <a href="' . route('userQuestions.show', [$data->id]) . '" class=\'btn btn-default btn-xs\'><i class="glyphicon glyphicon-eye-open"></i></a>
                                <a href="' . route('userQuestions.edit', [$data->id]) . '" class=\'btn btn-default btn-xs\'><i class="glyphicon glyphicon-edit"></i></a>
